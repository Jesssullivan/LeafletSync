...
- Save & load default prompt values with a file of environment variables; see template [`sampleEnv`](https://github.com/Jesssullivan/LeafletSync/blob/main/GitHubSampleEnv) & [`BitBucketSampleEnv`](https://github.com/Jesssullivan/LeafletSync/blob/main/BitBucketSampleEnv)
